...
const TCG_RECIPES: ArtisanRecipeDraft[] = [
  ...
  },
  {
    ...
    rewards: [{ type: 'item', targetId: 'pack-base2', quantity: 1, dropChance: 100 }],
    craftType: 'balance',
    outputQuantity: { min: 0, max: 2 },
    qualityOutputQuantity: { good: 1, perfect: 2 },
    minimumQuality: 'good',
    materialFailQualities: ['bad'],
    iconItemId: 'pack-base2',
    requirements: [{ type: 'task_completed', targetId: 'underground-tcg-my-very-own-set' }],
  },
  {
    ...
    rewards: [{ type: 'item', targetId: 'pack-base3', quantity: 1, dropChance: 100 }],
    craftType: 'balance',
    outputQuantity: { min: 0, max: 2 },
    qualityOutputQuantity: { good: 1, perfect: 2 },
    minimumQuality: 'good',
    materialFailQualities: ['bad'],
    iconItemId: 'pack-base3',
    requirements: [{ type: 'task_completed', targetId: 'underground-tcg-my-very-own-set' }],
  },
  {
  ...
  },
  {
    ...
    rewards: [{ type: 'item', targetId: 'pack-base5', quantity: 1, dropChance: 100 }],
    craftType: 'balance',
    outputQuantity: { min: 0, max: 2 },
    qualityOutputQuantity: { good: 1, perfect: 2 },
    minimumQuality: 'good',
    materialFailQualities: ['bad'],
    iconItemId: 'pack-base5',
    requirements: [
