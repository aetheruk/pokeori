...
const battleDefinitions: Record<KantoGymChronicleKey, ChronicleBattleDefinition[]> = {
  ...
  misty: [
    { id: 'service-gyarados', name: 'The Gyarados at the Cove', description: 'Clear a path to Horsea without harming the Gyarados warning everyone away from the cove.', icon: { type: 'pokemon', id: '130' }, background: '/backgrounds/chronicle-misty-cerulean-cape.avif', wild: true, enemyTeam: [{ speciesId: 130, formId: '130', level: 22 }] },
    { id: 'daisys-challenge', name: "Daisy's League Trial", description: 'Face Daisy in the formal trial that will place Cerulean Gym\'s battle programme in Misty\'s hands.', trainerClassId: 'swimmer-f', trainerName: 'Daisy', icon: { type: 'trainer', id: 'swimmer-f' }, background: '/backgrounds/chronicle-misty-cerulean-cape.avif', enemyTeam: [{ speciesId: 118, formId: '118', level: 19 }, { speciesId: 86, formId: '86', level: 21 }] },
  ],
  surge: [
