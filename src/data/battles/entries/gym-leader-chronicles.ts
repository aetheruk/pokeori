...
const battleDefinitions: Record<KantoGymChronicleKey, ChronicleBattleDefinition[]> = {
  ...
  misty: [
    { id: 'cape-gyarados', name: 'The Shape Beneath the Cape', description: 'Stand your ground when a territorial Gyarados cuts off the stranded Horsea.', icon: { type: 'pokemon', id: '130' }, background: '/backgrounds/chronicle-misty-cerulean-cape.avif', wild: true, enemyTeam: [{ speciesId: 130, formId: '130', level: 22 }] },
    { id: 'daisys-challenge', name: "Daisy's Challenge", description: 'Battle Daisy for the freedom to choose a life beyond the water shows.', trainerClassId: 'swimmer-f', trainerName: 'Daisy', icon: { type: 'trainer', id: 'swimmer-f' }, background: '/backgrounds/chronicle-misty-cerulean-cape.avif', enemyTeam: [{ speciesId: 118, formId: '118', level: 19 }, { speciesId: 86, formId: '86', level: 21 }] },
  ],
  surge: [
  ...
  sabrina: [
    { id: 'psychic-echo', name: 'The Psychic Echo', description: 'Face the reflection that repeats every fear Sabrina has absorbed from the room.', trainerClassId: 'psychic-f', trainerName: 'Younger Sabrina', icon: { type: 'trainer', id: 'psychic-f' }, background: '/backgrounds/chronicle-sabrina-quiet-mindscape.avif', enemyTeam: [{ speciesId: 64, formId: '64', level: 36 }, { speciesId: 96, formId: '96', level: 34 }, { speciesId: 93, formId: '93', level: 35 }] },
    { id: 'koichis-focus-test', name: "Koichi's Focus Test", description: 'Meet Koichi face to face and test whether silence must always mean isolation.', trainerClassId: 'black-belt', trainerName: 'Koichi', icon: { type: 'trainer', id: 'black-belt' }, background: '/backgrounds/gym-fighting.avif', enemyTeam: [{ speciesId: 106, formId: '106', level: 36 }, { speciesId: 107, formId: '107', level: 36 }] },
  ],
  blaine: [
