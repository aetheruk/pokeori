...
const battleDefinitions: Record<KantoGymChronicleKey, ChronicleBattleDefinition[]> = {
  ...
  erika: [
    { id: 'suffering-muk', name: 'A Frightened Muk', description: 'Calm the sick Muk without forcing it farther into the contaminated runoff.', icon: { type: 'pokemon', id: '89' }, background: '/backgrounds/chronicle-erika-dye-warehouse.avif', wild: true, maxPokemon: 3, enemyTeam: [{ speciesId: 89, formId: '89', level: 30, aiMoves: ['sludge', 'acid', 'harden'] }] },
    { id: 'developer-enforcer', name: 'Stop the Pump', description: 'Prevent Gable from emptying the chemical tank into the glasshouse drain before the inspector arrives.', trainerClassId: 'gentleman', trainerName: 'Gable', icon: { type: 'trainer', id: 'gentleman' }, background: '/backgrounds/chronicle-erika-dye-warehouse.avif', maxPokemon: 3, enemyTeam: [{ speciesId: 110, formId: '110', level: 28 }, { speciesId: 53, formId: '53', level: 29 }] },
  ],
  koga: [
