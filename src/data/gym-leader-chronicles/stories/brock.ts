...
export const brockChronicleStory: KantoGymChronicleStory = {
  sequence: [
    scene('backstory', 'the-cold-plate', 'One Place Set', 'Brock begins another morning by making Flint’s absence look temporary.', home, [
      narration('Before sunrise, the Harrison kitchen was already warm. Brock had five lunches open on the table, two pans on the stove and one untouched plate beside the window. The plate was becoming harder to explain.'),
      speech(forrest, 'Dad missed dinner and breakfast. Is he working at the quarry again, or is that just what we are telling the little ones?'),
      speech(brock, 'He left enough Gym work for three people. That is the part I can answer before school.'),
      speech(forrest, 'You always answer the question next to mine. You never answer mine.'),
    ]),
    scene('backstory', 'a-house-in-motion', 'The Morning List', 'The household runs because Brock has memorised every need and told nobody what it costs.', home, [
      speech(twins, 'We cannot find the blue bag. We found two green bags and a Geodude, but he says neither belongs to him.'),
      speech(brock, 'Forrest, check under the bench. Twins, sit down and eat. I will do the medicine, lunches, stove and Gym keys.'),
      speech(forrest, 'That is four jobs after you just gave me one. Give me another.'),
    ...
    scene('backstory', 'the-sugar-bowl', 'No Return Date', 'Forrest finds the note Brock has hidden beneath the sugar bowl.', home, [
      narration('When the door finally shut behind the last child, Brock lifted the sugar bowl. Flint’s note was folded into quarters beneath it, softened at the creases from being read too often.'),
    ...
    scene('backstory', 'onix-does-not-eat', 'The Other Empty Room', 'At Pewter Gym, Onix waits beside Flint’s vacant chair and refuses food.', gym, [
      narration('The Gym smelled of cold dust. A crack ran from the upper viewing rail to the battle floor. Onix had pushed his food dish against Flint’s chair and left it there.'),
      speech(forrest, 'He knows. You can tell people whatever you like, but Onix knows Dad left.'),
      speech(brock, 'Then help me move the dish. The League inspector arrives at ten.'),
      speech(forrest, 'What happens when she asks who the Leader is?'),
      speech(brock, 'I stand in the ring and make sure she does not need to ask twice.'),
    ]),
    ...
    scene('development', 'mara-at-the-door', 'A Provisional Answer', 'Mara finds a capable young trainer inside an unsafe Gym.', gym, [
      ...
      speech(brock, 'You found the person doing the work. I can demonstrate the team, the challenge rules and every repair still outstanding.'),
      speech(mara, 'Competence is not adulthood, Brock. It is also not a roof brace.'),
      speech(brock, 'Then give me the provisional assessment. If I fail it, close the Gym. If I pass, judge the building after I repair it.'),
      speech(mara, 'Thirty days. A safe floor, a responsible household plan and a battle assessment. I will not bend one of those because I admire the others.'),
    ]),
    scene('development', 'the-letter-in-the-ledger', 'A Different Future', 'Brock’s breeding-course offer sits unread beside the Gym accounts.', annex, [
      narration('The League annex kept copies of every application. Mara returned a letter Brock had sent months earlier: admission to a Pokémon breeding programme in Celadon, beginning in six weeks.'),
      ...
      speech(mara, 'That was not my question.'),
      speech(brock, 'It is the only answer that currently feeds everyone.'),
    ]),
    scene('development', 'taro-kept-his-ticket', 'The Promised Challenger', 'Taro arrives with a challenge booking Flint accepted before leaving.', gym, [
      ...
      speech(mara, 'No. The inspection is unfinished.'),
      speech(taro, 'I do not need a Badge if the Gym is closed. I just need somebody to stop treating my challenge like it never mattered.'),
    ...
    scene('development', 'stone-dust', 'The Wall Answers', 'The battle ends with Onix holding up the building instead of celebrating the result.', gym, [
      narration('Taro’s final command struck the floor. The west brace split with a sound too small for the weight above it. Onix crossed the ring before Brock spoke and pressed his body beneath the falling beam.'),
      speech(brock, 'Battle over. Forrest, clear the rail. Taro, take Geodude and do not run under the beam.'),
      speech(mara, 'Everyone outside. The Gym is closed effective now.'),
      speech(brock, 'Onix is still inside.'),
      speech(mara, 'Then we remove him together. You do not make yourself the second person trapped.'),
    ]),

    scene('conflict', 'the-closure-notice', 'A Door With No Badge', 'The closure notice makes Brock’s private crisis public.', gym, [
      narration('By evening, an ochre League notice covered the Gym schedule. Parents crossed the road to read it. Brock scrubbed stone dust from Onix while every whisper outside found its way through the broken wall.'),
      speech(forrest, 'The twins heard someone say Dad ran away because the Gym was failing.'),
      speech(brock, 'I will speak to them after I stabilise Onix.'),
    ...
    scene('conflict', 'forrest-finds-the-course', 'The Letter Opens', 'Forrest discovers what Brock has silently decided to surrender.', home, [
      ...
      speech(forrest, 'That is your favourite way to say no. You just wait until the choice dies on its own.'),
    ]),
    scene('conflict', 'flint-returns', 'The Key in Flint’s Hand', 'Flint returns expecting absence to be repaired by his presence.', home, [
      narration('Flint returned after dark with quarry dust on his coat and the old Gym key in his palm. The youngest children reached him first. Brock remained beside the stove.'),
      speech(flint, 'I heard about the wall. I should have been here. I can take the Gym back tomorrow and settle the inspector.'),
      speech(brock, 'You cannot settle her. You cannot walk into the chair because the room became inconvenient without you.'),
      speech(flint, 'I failed the League circuit. I could not come home and let all of you watch me be small.'),
      speech(forrest, 'So you made Brock small enough to fit every job you dropped.'),
    ]),
    scene('conflict', 'not-an-apology-yet', 'What Flint Left', 'Brock refuses the easy restoration Flint offers.', home, [
      ...
      speech(brock, 'You are sorry because you saw the damage. I needed you to be sorry when you wrote the note.'),
      speech(flint, 'What do you want me to do?'),
      speech(brock, 'Tonight? Wash the dishes. Tomorrow, tell every child where you went. Then show up again the day after that. The keys stay with Mara until the assessment.'),
    ...
    scene('conflict', 'the-quarry-price', 'Stone Is Not Free', 'The quarry foreman will donate stone only if the family can safely move it.', quarry, [
      narration('The quarry had the right stone and no spare cart. Brock began calculating how many pieces he could carry alone until Flint quietly put his shoulder beneath the first block.'),
      ...
      speech(forrest, 'That sounded almost like a plan made for more than one person.'),
    ]),
    ...
    scene('conflict', 'repair-lines', 'The Work Is Named', 'The family repairs the Gym by making every responsibility visible.', gym, [
      ...
      speech(forrest, 'And after this, breakfast rotates. I wrote it down before you could object.'),
      speech(flint, 'Put me on every early shift.'),
      speech(brock, 'No. Put yourself on the shifts you can keep. We have had enough promises made at full volume.'),
    ]),
    ...
    scene('conflict', 'the-repaired-line', 'A Scar in the Stone', 'The wall is safe, but Brock chooses not to hide where it failed.', gym, [
      narration('New stone crossed the old fracture in a pale diagonal. Brock refused the plaster that would have concealed it. Onix ate beside the repaired wall, watching Flint from across the room.'),
      speech(mara, 'The load test passes. The scar will invite questions.'),
      speech(brock, 'Good. A challenger should know this building can fail and still be made safe.'),
      speech(mara, 'Your household plan?'),
      speech(forrest, 'Signed by everyone. Including the parts where Brock is not allowed to volunteer for an empty space.'),
    ]),
    ...
    scene('contemplation', 'under-the-quarry-sky', 'The Life Beyond Pewter', 'Brock admits that staying and wanting to leave can both be true.', quarry, [
      ...
      speech(forrest, 'You taught us every job except how to live when you are not in the room. That is not the same as needing you forever.'),
      speech(brock, 'You should not have to become me because I leave.'),
      speech(forrest, 'Then do not leave the way Dad did. Tell us where. Tell us when. Come back when you said you would.'),
    ]),
    scene('contemplation', 'flint-at-the-table', 'A Father Without the Chair', 'Flint accepts that helping does not restore his authority.', home, [
      speech(flint, 'Mara says the League may license you. I thought I would feel replaced.'),
      speech(brock, 'Are you asking me to make you feel better about it?'),
      speech(flint, 'No. I am trying to notice when I do that. I can repair the roof and take the younger ones to school. I do not need the chair to be their father.'),
      speech(brock, 'Being their father is the part with the harder attendance requirement.'),
    ]),
    scene('contemplation', 'the-deferral-call', 'Not No', 'Brock asks the breeding programme for time instead of surrendering his place.', annex, [
      narration('Brock made the call from Mara’s office because the kitchen was too loud and the Gym too quiet. He expected the programme director to refuse.'),
      speech(brock, 'I am not declining. I am asking to defer one term while I establish a safe Gym rota and train a deputy.'),
      speech(mara, 'Say the next part.'),
      speech(brock, 'I still want the place.'),
      narration('The answer was not guaranteed, but it was an answer Brock had chosen before circumstances could choose it for him.'),
    ]),

    scene('resolution', 'mara-returns', 'The Assessment Begins', 'Mara inspects not only Brock’s team but the structure around him.', gym, [
      speech(mara, 'The wall is safe. The household plan has names beside every duty. Flint is present as guardian, not acting Leader. Now I need to see what kind of challenge you intend to run.'),
      ...
      speech(mara, 'Then show me. Three Pokémon, League rules, no special allowances for a compelling personal history.'),
    ]),
    ...
    scene('resolution', 'the-provisional-key', 'Leader of Pewter Gym', 'Mara grants Brock the key without pretending it solves his family.', gym, [
      ...
      speech(mara, 'It requires one. The League is finally learning that indispensable people are often evidence of a badly designed institution.'),
    ...
    scene('resolution', 'the-first-new-challenge', 'A Different Welcome', 'Taro returns to complete the challenge that exposed the Gym’s weakness.', gym, [
      ...
      speech(brock, 'It is part of the Gym now. So is the stop signal, the clear line and the person responsible for each rail.'),
      speech(taro, 'Do I get my battle this time?'),
      speech(brock, 'You get a safe one. If you find another weakness, tell me before the wall does.'),
    ]),
    ...
    scene('reflection', 'two-books-open', 'The Work That Remains', 'Brock’s two futures occupy the same desk.', gym, [
      ...
      speech(forrest, 'Reading is not a household emergency. That means you are still off.'),
    ...
    scene('reflection', 'the-chair-is-just-a-chair', 'No Place Empty', 'Brock stops measuring family by who occupies Flint’s old seat.', home, [
      narration('Flint’s old chair remained at the table, but nobody kept it empty anymore. Some mornings Flint sat there. Some mornings a twin piled schoolbooks on it. Once, Onix put his head through the window and took the entire loaf.'),
      speech(flint, 'You know, I used to think that chair meant I was in charge.'),
      speech(brock, 'It means you are nearest the stove. Turn the eggs before they burn.'),
