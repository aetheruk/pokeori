...
export const brockChronicleStory: KantoGymChronicleStory = {
  sequence: [
    ...
    scene('development', 'the-letter-in-the-ledger', 'A Different Future', 'Brock\'s breeding-course offer sits unread beside the Gym accounts.', annex, [
      narration('The League annex kept copies of every application. Mara handed Brock a letter he had sent months earlier: admission to a Pokemon breeding programme in Celadon, starting in six weeks.'),
    ...
    scene('development', 'before-the-first-command', 'Inside the White Line', 'Brock enters the ring knowing that winning is not the only thing being judged.', gym, [
      ...
      speech(brock, 'Understood. Taro, we battle to two conscious Pokemon. No attacks toward the west wall.'),
    ]),
    ...
    scene('conflict', 'the-closure-notice', 'A Door With No Badge', 'The closure notice makes Brock\'s private crisis public.', gym, [
      ...
      speech(brock, 'I know. I am trying to get ahead of it.'),
    ]),
    ...
    scene('contemplation', 'under-the-quarry-sky', 'The Life Beyond Pewter', 'Brock admits that staying and wanting to leave can both be true at once.', quarry, [
    ...
    scene('contemplation', 'flint-at-the-table', 'A Father Without the Chair', 'Flint accepts that helping does not restore his authority.', home, [
      ...
      speech(flint, 'No. I am trying to notice when I do that. I can fix the roof and take the little ones to school. I do not need the chair back to do that.'),
      speech(brock, 'Then show up for the early shifts you said you would.'),
    ]),
    ...
    scene('resolution', 'mara-returns', 'The Assessment Begins', 'Mara inspects not only Brock\'s team but the structure around him.', gym, [
      ...
      speech(mara, 'Then show me. Three Pokemon, League rules, no special allowances for a moving personal story.'),
    ]),
