...
export const mistyChronicleStory: KantoGymChronicleStory = {
  sequence: [
    ...
    scene('conflict', 'the-horsea-rescue', 'When the Water Settles', 'The battle creates enough space to free Horsea, but costs Misty her appointment.', cape, [
      narration('Starmie’s final screen turned the ranger’s net aside. Gyarados wore itself out against the current, then let Misty close enough to cut Horsea free. By the time both Pokémon reached open water, the League steward’s launch was pulling away from the pier.'),
