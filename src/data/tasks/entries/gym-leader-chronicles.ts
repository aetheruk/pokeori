...
const storyBeats: Record<KantoGymChronicleKey, ChronicleBeat[]> = {
  ...
  erika: [
    ...
    { id: 'whispers', title: 'Following the Drain', description: 'Erika traces the contaminated water into the neighbouring warehouse.', message: "Tangela followed the drain to a cracked storage tank beneath the warehouse. The leak was much older than the company's purchase, but the site report filed with its planning application said the ground was clean. The purchase contract and the report both carried a small black Rhyhorn stamp." },
    { id: 'public-bloom', title: 'The Inspection', description: 'The gardeners protect the site long enough for the city inspector to see it.', message: 'The site manager came early to clear the east beds, but we kept him out until the city inspector arrived. At the planning hearing, we showed the drain maps, the water samples, and the cracked tank. The city rejected the application and ordered the company to pay for the cleanup.' },
