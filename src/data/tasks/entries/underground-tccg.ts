...
export const undergroundTccgTasks: Task[] = [
  ...
  },
  {
    ...
    description: 'I’m getting the hang of the battle game, but apparently battles do not bring in Crystals.',
    category: 'Underground',
    subCategory: 'Kanto Underground',
    icon: maniacMale,
    background: undergroundBackground,
    ...
    exitModal: {
      ...
      icon: maniacMale,
      message: 'Congratulations {Trainer}, you are getting the hang of the battle game! Do not get too distracted though. Battles are fun, but they do not bring in Crystals. Making cards does: we make cards, put them into packs, and collectors hand over Crystals for them. Now design your first card and see what you can make.',
