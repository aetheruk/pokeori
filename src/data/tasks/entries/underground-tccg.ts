    ...
    enterModal: [
      {
        ...
        title: 'Cal',
        message:
          'Cal gathers his cards with wounded dignity. “Three matches is enough. There is no point playing you any more.” Marina is already waiting at the next table.',
        background: undergroundBackground,
        icon: maniacMale,
    ...
    enterModal: [
      {
        ...
        title: 'Marina',
        message:
          'Marina adds your third result to the excellent pile. “There is no point playing you any more. Fern organizes the actual outreach.” She points toward an even larger crowd.',
        background: undergroundBackground,
        icon: maniacFemale,
