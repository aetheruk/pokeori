...
export const pokemonTowerTasks: Task[] = [
  ...
  },
  {
    ...
    enterModal: [
      ...
      },
      {
        id: 2,
        title: '{trainer}',
        message: 'You step onto the floorboards. The figure turns. It is Kita, but transformed—her bone club burns with otherworldly spirit fire, and her dark eyes glint with raw sorrow and rage. She does not recognize you through her grief.',
        background: '/backgrounds/pkmn-tower.avif',
        icon: { type: 'pokemon', id: '105' },
      ...
      },
      {
        id: 3,
        title: 'Detective Ray Choo',
        message: 'Her spirit was transformed by grief and death into an Alolan Marowak! Words won’t break through that spectral tempest, {trainer}. We need to battle her and quell the rage burning in her heart! Ready your two strongest Pokemon!',
        background: '/backgrounds/pkmn-tower.avif',
        icon: { type: 'trainer', id: 'detective' },
    ...
    exitModal: {
      background: '/backgrounds/pkmn-tower.avif',
      title: 'A Trial of Spirits',
      icon: { type: 'pokemon', id: '105' },
      message: 'Challenge Kita at the summit. You may bring 2 Pokemon (Level Cap: 40) to quell the spectral fire and bring peace to her spirit.',
  ...
  },
  {
    ...
    description: 'Discover the note addressed to {trainer} and claim the Azure Flute at the summit of Pokemon Tower.',
    category: 'Kanto',
    subCategory: 'Pokemon Tower',
    icon: {
      type: 'item',
    ...
    enterModal: [
      ...
      },
      {
        id: 2,
        title: 'Kita',
        message: 'Kita lowers her bone club as the green flames settle into a warm, gentle light. She looks deeply into your eyes, giving a slow, peaceful nod of recognition and gratitude before dissolving into shimmering stardust.',
        background: '/backgrounds/pkmn-tower.avif',
        icon: { type: 'pokemon', id: '105' },
        buttons: [{ text: 'Examine the Floor', type: 'navigate', id: 3 }],
      },
      {
        id: 3,
        ...
        buttons: [{ text: 'Ray’s Realization', type: 'navigate', id: 4 }],
      },
      {
        id: 4,
        title: 'Detective Ray Choo',
