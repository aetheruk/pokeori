  ...
  misty: {
    sequence: [
      scene(
        ...
        'Misty keeps turning the sisters\' choreography into battle practice.',
        mistyTheater,
        [
          speech(characters.daisy, 'Misty, the turn is on four. Not whenever Starmie sees an opening.'),
          speech(characters.misty, 'It saw an opening.'),
          speech(characters.violet, 'We are dancing, not challenging the front row.'),
          speech(characters.misty, 'Then why put a battle platform in a pool?'),
          speech(characters.lily, 'Because it rises. It is dramatic.'),
          speech(characters.daisy, 'Again from the top. This time, stay with us.'),
        ],
      ),
      game('finale-rehearsal'),
      scene(
        'after-the-music',
        'Two Plans for One Afternoon',
        'Daisy gives Misty the centre of the preview without asking about the League trial she arranged.',
        mistyTheater,
        [
          speech(characters.daisy, 'Perfect. Keep that up and you can take centre pool at the preview.'),
          speech(characters.misty, 'I cannot. My League trial is at Cerulean Cape this afternoon.'),
          speech(characters.daisy, 'You chose today?'),
          speech(characters.misty, 'They gave me today. You chose the preview for me.'),
          speech(characters.violet, 'We thought you wanted to be in it.'),
          speech(characters.misty, 'I am with you every day. None of you ever ask what I want to do here.'),
        ],
      ),
      scene(
        'horsea-leaves-the-stage',
        'The Empty Mark',
        'A frightened Horsea bolts from the preview and follows the north canal toward Cerulean Cape.',
        mistyTheater,
        [
          narration('The preview crowd leaned forward as the Horsea entered. One missed its mark, flinched at the applause, and vanished through the open show canal.'),
          speech(characters.daisy, 'Close the curtain. Tell them we are taking an interval.'),
          speech(characters.misty, 'Horsea took the north canal. It leads straight to the Cape.'),
          speech(characters.lily, 'It hates open water.'),
          speech(characters.violet, 'Then we go now.'),
          speech(characters.daisy, 'All four of us. Nobody drives it farther by shouting.'),
        ],
      ),
      game('listen-across-the-water'),
      scene(
        'the-shape-in-the-water',
        'The Cove Answers Back',
        'Misty hears Horsea in a narrow cove guarded by an agitated Gyarados.',
        mistyCape,
        [
          speech(characters.misty, 'Horsea is behind that ledge. Gyarados is warning us away from it.'),
          speech(characters.daisy, 'We can wait for the Cape ranger.'),
          speech(characters.misty, 'Horsea is getting quieter. I can clear a path without hurting Gyarados.'),
          speech(characters.daisy, 'Then show it we are listening.'),
        ],
      ),
      ...
      scene(
        'the-horsea-rescue',
        'No Spotlight',
        'Misty gives Horsea the quiet choice it was denied on stage.',
        mistyCape,
        [
          narration('When Psyduck loosened the fishing line caught around its tail, Gyarados slipped into deeper water. Horsea remained curled beneath the ledge.'),
          speech(characters.misty, 'Do not reach for it. It ran because everyone kept telling it where to stand.'),
          speech(characters.daisy, 'That was not only about Horsea.'),
          speech(characters.misty, 'No.'),
          speech(characters.lily, 'What does it want?'),
          speech(characters.misty, 'A quiet way home. Starmie can make one.'),
          speech(characters.violet, 'We will follow behind. No applause.'),
        ],
      ),
      scene(
        'what-the-gym-is-for',
        'Four Different Answers',
        'At the Cape, the sisters finally say what each of them wants from Cerulean Gym.',
        mistyCape,
        [
          speech(characters.daisy, 'I thought you hated the work. You hate being fitted into ours.'),
          speech(characters.misty, 'I hate being the spare sister whenever your formation needs four people.'),
          speech(characters.violet, 'We like the show.'),
          speech(characters.misty, 'I know. You should get to.'),
          speech(characters.lily, 'And you like making strangers panic with Starmie.'),
          speech(characters.daisy, 'Battling. She calls it battling.'),
          speech(characters.misty, 'Thank you.'),
        ],
      ),
      scene(
        'daisys-challenge',
        'The Trial She Asked For',
        'Daisy offers to stand opposite Misty in the League trial instead of choosing her place for her.',
        mistyCape,
        [
          speech(characters.daisy, 'The League assessor still expects one of us at the Cape. Let me stand in for the trial.'),
          speech(characters.misty, 'Are you testing me or stopping me?'),
          speech(characters.daisy, 'Testing whether you are ready. If I wanted to stop you, I would ask Violet to hide your shoes.'),
          speech(characters.violet, 'I already gave them back.'),
          speech(characters.misty, 'Fine. But do not go easy because we share a bathroom.'),
          speech(characters.daisy, 'I have shared a bathroom with you. I know better.'),
        ],
      ),
      battle('daisys-challenge'),
      scene(
        'two-programmes',
        'Book Around the Battles',
        'Daisy hands Misty the whole battle programme, not the hours left over after performances.',
        mistyTheater,
        [
          speech(characters.daisy, 'You never waited for the assessor to applaud.'),
          speech(characters.misty, 'I was busy winning.'),
          speech(characters.daisy, 'Then the battle programme is yours.'),
          speech(characters.misty, 'All of it. Not afternoons when the stage happens to be empty.'),
          speech(characters.daisy, 'All of it. We book the shows around the battles.'),
          speech(characters.lily, 'Can our stage still sparkle?'),
          speech(characters.misty, 'If it survives Starmie, it can sparkle.'),
        ],
      ),
      scene(
        'two-posters',
        'Side by Side',
        'The sisters put their separate ambitions on the wall without making either one smaller.',
        mistyTheater,
        [
          narration('Two fresh posters dried on the office table: The Sensational Sisters Water Show, and Cerulean Gym Challenges, led by Misty.'),
          speech(characters.violet, 'Your name is larger than ours.'),
          speech(characters.misty, 'My poster has fewer words.'),
          speech(characters.daisy, 'Horsea gets final approval before either one goes up.'),
          speech(characters.misty, 'Horsea gets a quiet tank and no spotlight.'),
          speech(characters.lily, 'You really are terrible at show business.'),
          speech(characters.misty, 'Finally, something we agree on.'),
        ],
      ),
    ],
  },
