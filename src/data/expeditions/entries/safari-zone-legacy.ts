...
function legacySafariExpedition({
  id,
  name,
  description,
  fieldResearchId,
...
/** Old public expedition definitions kept only for active/claimable legacy runs. */
export const legacySafariZoneExpeditions: ExpeditionConfig[] = [
  legacySafariExpedition({
