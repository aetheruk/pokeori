...
export const POKEMON_RARITY_EFFECTS = [
  ...
  },
  {
    id: 'emerald',
    label: 'Emerald',
    description: 'Deep green gemstone tint; starts battle with Shield.',
    group: 'cosmetic',
    sourcePalette: 'normal',
  },
  {
    id: 'ruby',
    label: 'Ruby',
    description: 'Rich red gem tone; starts battle with Shield.',
    group: 'cosmetic',
    sourcePalette: 'normal',
  },
  {
    id: 'sapphire',
    label: 'Sapphire',
    description: 'Blue crystal treatment; starts battle with Shield.',
    group: 'cosmetic',
    sourcePalette: 'normal',
  },
  {
