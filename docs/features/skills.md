...
- Researcher 32 adds Neutral Stone discovery: after completing Celadon Mansion's `A Craftsman's Secret`, every Field Observation independently rolls a Neutral Stone at 1-in-35. Artisan 30 lists Elemental Stonecraft, whose recipes are taught by that same Gentleman task.
