...
- Field Observation dye nut drops unlock from Researcher 1-40, with Razz Berry joining that pool at Researcher 14 at a lower selection weight than dye nuts. Researcher 37 adds a second independent roll of the existing nut table. Healing berry drops unlock at Researcher 16 with Oran, Cheri, Chesto, Pecha, Rawst, Aspear, and Persim together, then add Sitrus and Lum at Researcher 38. At Researcher 42, EV-reducing berries unlock as their own independent 0-1 Field Observation drop roll instead of joining the healing pool. Berries are no longer awarded from Pokemon catches. Trainer level still controls battle use and held use.
