...
- Higher battle powers unlock from Trainer level 65 onward: Weather Power 65, Tera 70, Mega 75, Z-Move 80, Dynamax 85, Victory Power 90, Circadian Power 95, and Dimensional Shift 95.
...
- Field Observation dye nut drops unlock from Researcher 1-40, with Razz Berry joining that pool at Researcher 14 at a lower selection weight than dye nuts. Researcher 37 adds a second independent roll of the existing nut table. Healing berry drops unlock at Researcher 16 with Oran, Cheri, Chesto, Pecha, Rawst, Aspear, and Persim together, then add Sitrus and Lum at Researcher 38. At Researcher 42, EV-reducing berries unlock as their own independent 0-1 Field Observation drop roll instead of joining the healing pool. The guaranteed global capture berry pool is removed; ability-based capture rewards can still award berries. Trainer level still controls battle use and held use.
- Researcher 25 adds Neutral Stone discovery: after completing Celadon Mansion's `A Craftsman's Secret`, every Field Observation independently rolls a Neutral Stone at 1-in-16. Artisan 30 lists Elemental Stonecraft, whose recipes are taught by that same Gentleman task.
