...
- Successful completions grant one generated Researching XP reward, Pokemon Research XP, and tapped active drops. Failed reports still follow the shared 30% gathered-item loss rule, including for a collected Research Kit. Field Observation no longer grants direct currency.
