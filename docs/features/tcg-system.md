...
- Carddex expansion lists and Trainer deck-series selectors use chronological release order rather than alphabetical order; series are positioned by their earliest expansion release.
