...
- The tutorial, Fire, Water, and Grass battles use Rattata, Charizard, Blastoise, and Venusaur icons respectively; the three post-training rematches retain the elemental icons and 350-Pokédollar payouts. The Celadon Game Corner tables use the male TCG Maniac sprite for the low-stakes table and the female sprite for the high-stakes table. Every authored opponent deck is validated as a legal 15-card Baby deck before battle start, including the format cost cap.
