...
- A single owned Pokemon performs the channeling. Every ritual keeps a minimum level and may optionally require one Pokemon type or an exact form ID. The searchable picker covers the full owned roster, marks ineligible Pokemon, and the server independently enforces the same requirement.
...
Fuji's Glasses Memory uses Memory Incense, 5 Ground energy, and any level 5+ Pokemon to unlock the Mr. Fuji Pokemon Tower Chronicle.
