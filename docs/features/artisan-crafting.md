...
- The TCG category unlocks after the Basic Training “My Very Own Set” task. Foil Pack uses Scatter and costs 2 T1 Metal Scrap, producing 0/3/5 on Bad/Good/Perfect quality. Base Set, Jungle, Fossil, and Base Set 2 Booster Packs use Balance and cost one Empty Foil Pack plus one Dried Purple, Green, Yellow, or Red Dye respectively. Team Rocket uses one Empty Foil Pack plus one Dried Black Dye and stays hidden until the player owns its binder. Set-pack recipes produce 0/1/2 on Bad/Good/Perfect quality, and Bad quality consumes the materials.
