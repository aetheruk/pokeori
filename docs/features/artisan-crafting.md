...
- Evolution Catalysts are guaranteed Balance crafts at Artisan 5, 20, and 40. The low, mid, and high catalysts cost 25/300/500 Crystals plus 10 XS, 25 S, or 50 M PokePowder respectively, use palette-swapped Scarlet/Violet Max Revive sprites, and are consumed by pure level-based Pokémon evolutions. Max Revive is also registered as a Battling 60 full-heal revive item.
