...
- Regular candies and Candy Bags always raise or set a Pokémon's level when the selected Pokémon is inside the item's tier and current badge level cap. Uses beyond the badge cap remain unavailable and do not consume the item.
